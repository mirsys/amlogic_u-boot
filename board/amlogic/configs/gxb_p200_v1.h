...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setenv bootargs ${bootargs} androidboot.hardware=amlogic;"\
        ...
        "storeboot="\
            ...
            "\0"\
        "bootsdcard="\
            "run sdcardargs; mmcinfo; fatload mmc 0 ${uaddr} uInitrd;fatload mmc 0 ${kaddr} Image; booti ${kaddr} ${uaddr} ${fdt_addr};"\
            "\0"\
        "bootupdate="\
...
#define CONFIG_ENV_OFFSET  (720*1024)
#define CONFIG_FIT 1
...
#define CONFIG_AML_SECURITY_KEY                 0
#define CONFIG_UNIFY_KEY_MANAGE                 0
...
//support secure boot
#define CONFIG_AML_SECURE_UBOOT   0
